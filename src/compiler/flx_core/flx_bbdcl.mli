...
type t = private
  ...
  | BBDCL_external_type of
                        bvs_t * btype_qual_t list * Flx_code_spec.t * breqs_t
  ...
  | BBDCL_external_code of
                        bvs_t * Flx_code_spec.t * ikind_t * breqs_t
...
val bbdcl_external_type : bvs_t * btype_qual_t list * Flx_code_spec.t * breqs_t -> t
val bbdcl_external_const :
  property_t list * bvs_t * Flx_btype.t * Flx_code_spec.t * breqs_t ->
  t
val bbdcl_external_fun :
  property_t list * bvs_t * Flx_btype.t list * Flx_btype.t * breqs_t * prec_t *
    external_fun_kind_t ->
  t
val bbdcl_external_code : bvs_t * Flx_code_spec.t * ikind_t * breqs_t -> t
val bbdcl_union : bvs_t * (Flx_id.t * int * Flx_btype.t) list -> t
val bbdcl_struct : bvs_t * (Flx_id.t * Flx_btype.t) list -> t
val bbdcl_cstruct : bvs_t * (Flx_id.t * Flx_btype.t) list * breqs_t -> t
